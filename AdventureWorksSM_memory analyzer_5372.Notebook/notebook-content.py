...
dataset = "AdventureWorksSM" # Enter the name or ID of the semantic model
workspace = "adventureworks" # Enter the workspace name or ID in which the semantic model exists
